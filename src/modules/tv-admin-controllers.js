    ...
    .controller('tvAdminController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util', 'CONFIG',
        function ($scope, $state, $http, $stateParams, $location, util, CONFIG) {
            ...
            $scope.my_tree_handler = function(branch) {
                ...
                // QHtl_live
                if(branch.data.type == 'QHtl_Live') {
                    $state.go('app.tvAdmin.QHtl_live', {moduleId: branch.data.moduleId, label: branch.label});
                    self.changeMenuInfo();        
                }
                ...
                // QHtl_simplePicText
                if(branch.data.type == 'QHtl_SimplePicText') {
                    $state.go('app.tvAdmin.QHtl_simplePicText', {moduleId: branch.data.moduleId, label: branch.label});
                    self.changeMenuInfo();        
                }
...
console.log("Samsung_Lunch_PicText_Classification")
    ...
    //快捷 Live
    .controller('tvLiveQHtlController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util',
            function ($scope, $state, $http, $stateParams, $location, util) {
                var self = this;
    ...
    // 添加“LiveQHtl“模块内的直播
    .controller('tvLiveQHtlAddController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util', 'CONFIG',
        function ($scope, $state, $http, $stateParams, $location, util, CONFIG) {
            var self = this;
    ...
    // 编辑“LiveQHtl“模块内的直播
    .controller('tvLiveQHtlEditController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util', 'CONFIG',
            function ($scope, $state, $http, $stateParams, $location, util, CONFIG) {
                var self = this;
    ...
    .controller('tvQHtlSimplePicTextController', ['$scope', '$state', '$http', '$stateParams', '$location', 'util',
        function ($scope, $state, $http, $stateParams, $location, util) {
            var self = this;
